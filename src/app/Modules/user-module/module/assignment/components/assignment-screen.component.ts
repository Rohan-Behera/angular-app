...
import { Batches, Program } from './assignment-screen.modal';
import { Courses } from './assignment-screen.modal';
import { Topic } from './assignment-screen.modal';
import { Code } from './assignment-screen.modal';

@Component({
  selector: 'app-assignment-screen',
  templateUrl: './assignment-screen.component.html',
  styleUrls: ['./assignment-screen.component.css']
})
export class AssignmentScreenComponent {
  status = true;
  codeStatus = true;
